    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>Maharashtra Shasan</h1>
          <h2>State of Dreams</h2>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="img/home/map.svg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>About</h3>
            <p class="font-italic">
              Maharashtra is a state in the western peninsular region of India occupying a substantial portion of the Deccan Plateau. As the home of the Marathi people, Maharashtra is the second-most populous state and third-largest state by area in India.
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i><strong>Population:</strong> 11.42 crores (2012)</li>
              <li><i class="ri-check-double-line"></i><strong>Capital:</strong> Mumbai</li>
              <li><i class="ri-check-double-line"></i><strong>Governor:</strong> Bhagat Singh Koshyari</li>
              <li><i class="ri-check-double-line"></i><strong>Formation:</strong> 1 May 1960</li>
            </ul>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="https://www.maharashtra.gov.in/1198/Maharashtra-IT-ITES-Policy">Maharashtra IT/ITES Policy</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="https://www.maharashtra.gov.in/Pdf/ESM_2019_20_Eng_Book.pdf">Economic Survey of Maharashtra 2019-20</a></h4>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="https://www.maharashtra.gov.in/1213/1225/">Budget Speech dated 6th March, 2020</a></h4>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <img src="img/home/hospital.jpg" class="img-fluid" alt="" style="height: 220px; width: 420px;">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <img src="img/home/govt.png" class="img-fluid" alt="" style="height: 220px; width: 420px;">
            <div class="portfolio-info">
