                ...
                <div class="col-lg-6">
                    <div class="bradcam_text">
                        ...
                        <h1>Covid Care Centers</h1>
                            <p>1200 Beds Ready At Mehboob Studios & Xavier’s As Patients Increase</p>
                            <p>Maharashtra has been the hotspot of COVID-19 patients ever since the pandemic spread in India and Mumbai has most cases in the state. Plans are underway to create more jumbo care centres, like MMRDA grounds in Bandra-Kurla Complex and NESCO in Goregaon.</p>
      ...
      <div class="container  text-center">
        ...
        <div class="row col-lg-12">
          ...
          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/maharashtra/">Isolation Centers</a></h4>
          </div>

          <div class="col-lg-4 " data-aos="zoom-in" data-aos-delay="100">
            <h4><a href="https://covidindia.org/maharashtra/">Quarantine Centers</a></h4>
          </div>
   ...
   <script type="text/javascript">
    ...
    success : function(covid_data) {
     ...
     var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Maharashtra';
